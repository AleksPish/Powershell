...
#Borrowed from here: https://36chambers.wordpress.com/2022/01/18/getting-the-sql-server-product-key-via-powershell/
function Get-SqlServerProductKey($InstanceName="MSSQL13.MSSQLSERVER") {
